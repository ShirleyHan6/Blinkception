...
SHAPE_PREDICTOR_PATH = r'/home/rohan/Downloads/shape_predictor_68_face_landmarks.dat'
...
# from playground import interactElement, getCurrentElement

user=faceRecognize.is_recognized()
f=open(r'userThresholds.txt','rb')
try:
